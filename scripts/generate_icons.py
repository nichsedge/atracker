...
def main():
    ...
    # 1. Generate high-resolution logo.png if not present
    ...
    # The background rect is: <rect width="512" height="512" rx="128" fill="url(#bgGrad)" stroke="#1F1635" stroke-width="6" />
    ...
    # 4. Create Monochrome SVG (same as foreground, but all fills/strokes tinted white)
    mono_svg_content = fg_svg_content
    mono_svg_content = mono_svg_content.replace('stroke="url(#shieldGrad)"', 'stroke="#FFFFFF"')
    mono_svg_content = mono_svg_content.replace('stroke="url(#hourglassGrad)"', 'stroke="#FFFFFF"')
    mono_svg_content = mono_svg_content.replace('stroke="url(#orbitGrad)"', 'stroke="#FFFFFF"')
    mono_svg_content = mono_svg_content.replace('fill="#8A3DFF"', 'fill="#FFFFFF"')
    mono_svg_content = mono_svg_content.replace('stroke="#00D2FF"', 'stroke="#FFFFFF"')
    mono_svg_content = mono_svg_content.replace('fill="#00D2FF"', 'fill="#FFFFFF"')
    ...
    # Android mipmap densities and their corresponding sizes:
    # Foreground/Monochrome: 108dp base
    # Legacy Launcher / Round: 48dp base
    densities = {
